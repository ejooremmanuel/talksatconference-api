...
const attendee_schema_1 = require("./attendee.schema");
let Chat = class Chat {
};
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose.Schema.Types.ObjectId, ref: 'Attendee' }),
    __metadata("design:type", attendee_schema_1.Attendee)
